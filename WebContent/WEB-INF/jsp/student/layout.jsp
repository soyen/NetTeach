...
<tr>
<td width="238" height="569" valign="top" background="<%=request.getContextPath()%>/images/pic_student/left.jpg" style="background-position:top; background-repeat:no-repeat" >
<table width="188" height="75" border="0" cellpadding="0" cellspacing="0">
 ...
 <table width="97%">
<tr>
<td height="162" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=<%=request.getContextPath()%>/images/pic_admin/dfdffd.jpg, sizingMethod=scale); width:100%;height:29px"> &nbsp;&nbsp;<span class="start_title">${user.name}同学，欢迎使用本系统</span></td>
</tr>
</table>
<br/>
